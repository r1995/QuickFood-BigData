                        ...
                        <form action="javascript:void(0)">
                            <div className="form-row">
                                ...
                                <div className="form-group col-md-6">
                                    ...
                                    <input type="email" autoComplete="false" className="form-control" id="userEmail" placeholder="Email" onKeyUp={(e) => this.handleUserEmail(e.target.value)} />
                                </div>
                            </div>
                            <div className="form-row">
                                <div className="form-group col-md-6">
                                    <label htmlFor="userPassword">Password</label>
                                    <input type="password" autoComplete="new-password" className="form-control" id="userPassword" placeholder="Password" onKeyUp={(e) => this.handleUserPassword(e.target.value)} />
                                </div>
                                <div className="form-group col-md-6">
                            ...
                            <div className="form-row">
                                ...
                                <div className="form-group col-md-12">
                                    ...
                                    <div className="custom-file">
                                        <input type="file" className="custom-file-input" id="userProfileImage" accept="image/*" onChange={this.handleUserProfileImage} />
