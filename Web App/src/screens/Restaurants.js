                                ...
                                <div className="listing-filter">
                                    ...
                                    <div>
                                        <ul className="filter-list">
                                            ...
                                            <li>
                                                <div className="custom-control custom-checkbox">
                                                    <input type="checkbox" className="custom-control-input" id="beef-roast" name="Fish Fry" onChange={this.handleCategoriesCheckbox} />
                                                    <label className="custom-control-label" htmlFor="beef-roast">Fish Fry</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="custom-control custom-checkbox">
