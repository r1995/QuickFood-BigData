...
var firebaseConfig = {
    ...
    apiKey: "AIzaSyAFS2BvIbE1K_nOETUKoR5dN91R6wQ43r4",
    authDomain: "fooddeliveryapp-ac34f.firebaseapp.com",
    databaseURL: "https://fooddeliveryapp-ac34f.firebaseio.com",
    projectId: "fooddeliveryapp-ac34f",
    storageBucket: "fooddeliveryapp-ac34f.appspot.com",
    messagingSenderId: "330934310455",
    appId: "1:330934310455:web:1d7489976ea1054423d1b2"
    //measurementId: "G-0G2FBTJVBL"
};
...
function logIn(userLoginDetails) {
    return new Promise((resolve, reject) => {
        ...
        console.log("firebase"+userLoginDetails);
